 ...
 *
 * IMPORTANTE:
 * Esta classe NÃO possui motores matemáticos.
 * Ela apenas apresenta os resultados recebidos
 * pelo DopmDashboardController.
 */
class DopmDashboardViewV2(
    context: Context
) : ScrollView(context) {
