...
enum class AssetCategory {
    FOREX, CRYPTO, INDEX, METAL, ENERGY, STOCK, ETF
}
...
object AssetRegistry {
    ...
    private val assets = listOf(
        ...
        MarketAsset("SOL/USD","Solana / Dólar",AssetCategory.CRYPTO,"SOL/USD"),
        ...
        // ÍNDICES
        // Estes IDs são aliases amigáveis.
        // O SymbolResolver confirma o símbolo disponível na Twelve Data.
        ...
        // ETFs
        MarketAsset("QQQ","Nasdaq 100 ETF",AssetCategory.ETF,"QQQ"),
        MarketAsset("SPY","S&P 500 ETF",AssetCategory.ETF,"SPY")
    )

    fun get(id: String): MarketAsset? =
        assets.firstOrNull {
            it.id.equals(
                id.trim(),
                ignoreCase = true
    ...
    fun twelveDataSymbol(
        id: String
    ): String =
        get(id)?.twelveDataSymbol
            ?: id.trim()
}
