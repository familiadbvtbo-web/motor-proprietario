...
class MainActivity : AppCompatActivity() {
                ...
                val sequence = SequenceEngine.advance(
                    ...
                    SequenceInput(
                        ...
                        continuation = when (bestDirection) {
                            "COMPRA" -> bestMetrics.ema9 > bestMetrics.ema21 && bestMetrics.macd > bestMetrics.macdSignal
                            "VENDA" -> bestMetrics.ema9 < bestMetrics.ema21 && bestMetrics.macd < bestMetrics.macdSignal
                            else -> false
                        },
    ...
    private fun finalDirection(
        ...
        if (!qualityOk || !coverageOk || !riskOk || !confirmationOk) return "NEUTRO"
